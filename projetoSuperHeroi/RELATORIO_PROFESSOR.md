# Relatório Técnico — Projeto: Quiz dos Heróis

Data: 02/11/2025

Este documento descreve em detalhe o que foi implementado no projeto *Quiz dos Heróis*, como a solução está organizada, quais conceitos de orientação a objetos foram aplicados, como as Activities funcionam e como os estados são mantidos entre recriações. O objetivo é fornecer ao professor um panorama completo para que ele entenda exatamente como chegar ao estado atual do app a partir do código-fonte.
